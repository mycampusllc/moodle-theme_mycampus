...
function mycampus_coursecategorystatistics($html)		{
	...
	$coursecategorystatistics_id							= get_string('coursecategorystatistics_id', 'theme_mycampus');
	$coursecategorystatistics_category						= get_string('coursecategorystatistics_category', 'theme_mycampus');
	$coursecategorystatistics_coursenumber					= get_string('coursecategorystatistics_coursenumber', 'theme_mycampus');
	$coursecategorystatistics_coursenumberincludedocument	= get_string('coursecategorystatistics_coursenumberincludedocument', 'theme_mycampus');
	$coursecategorystatistics_percentage					= get_string('coursecategorystatistics_percentage', 'theme_mycampus');
	$coursecategorystatistics_resourcesnumber				= get_string('coursecategorystatistics_resourcesnumber', 'theme_mycampus');
	$coursecategorystatistics_total							= get_string('coursecategorystatistics_total', 'theme_mycampus');
