...
function mycampus_activeteachersstatistics($html)		{
	...
	$得到每天系统登录的用户数量_XX[] = get_string('activeteachersstatistics_table_header_1', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('activeteachersstatistics_table_header_2', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('activeteachersstatistics_table_header_3', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('activeteachersstatistics_table_header_4', 'theme_mycampus');
	...
	$activeteachersstatistics_table				= get_string('activeteachersstatistics_table', 'theme_mycampus');
	...
	$activeteachersstatistics_table_date		= get_string('activeteachersstatistics_table_date', 'theme_mycampus');
