...
function mycampus_useraccessstatistics($html)		{
	...
	$得到每天系统登录的用户数量_XX[] = get_string('useraccessstatistics_table_header_1', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('useraccessstatistics_table_header_2', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('useraccessstatistics_table_header_3', 'theme_mycampus');
	$得到每天系统登录的用户数量_XX[] = get_string('useraccessstatistics_table_header_4', 'theme_mycampus');
	...
	//print_R($得到每天系统登录的用户数量);exit;
	$useraccessstatistics_table				= get_string('useraccessstatistics_table', 'theme_mycampus');
	...
	$useraccessstatistics_table_date		= get_string('useraccessstatistics_table_date', 'theme_mycampus');
