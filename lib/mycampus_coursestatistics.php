...
function mycampus_coursestatistics($html)		{
	...
	$mycampus_GetCourseQuizNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		...
		$mycampus_GetCourseQuizNumber[$course] = $NUM;
	}

	$mycampus_GetCourseSectionNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		$NUM		= $rsC_a[$i]['NUM'];
		$course		= $rsC_a[$i]['course'];
		$mycampus_GetCourseSectionNumber[$course] = $NUM;
	}

	$mycampus_GetCourseEnrollmentStudentNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		$NUM		= $rsC_a[$i]['NUM'];
		$course		= $rsC_a[$i]['course'];
		$mycampus_GetCourseEnrollmentStudentNumber[$course] = $NUM;
	}
	...
	$mycampus_GetCourseOneMouthActivesNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		...
		$mycampus_GetCourseOneMouthActivesNumber[$course] = $NUM;
	}
	...
	$coursestatistics_updatedate	= get_string('coursestatistics_updatedate', 'theme_mycampus');
	$coursestatistics_orderdatarule = get_string('coursestatistics_orderdatarule', 'theme_mycampus');

	$coursestatistics_category_1	= get_string('coursestatistics_category_1', 'theme_mycampus');
	$coursestatistics_category_2	= get_string('coursestatistics_category_2', 'theme_mycampus');
	$coursestatistics_coursename	= get_string('coursestatistics_coursename', 'theme_mycampus');
	...
	$coursestatistics_files			= get_string('coursestatistics_files', 'theme_mycampus');
	$coursestatistics_documents		= get_string('coursestatistics_documents', 'theme_mycampus');
	...
	$coursestatistics_assesment		= get_string('coursestatistics_assesment', 'theme_mycampus');
	$coursestatistics_userlogin		= get_string('coursestatistics_userlogin', 'theme_mycampus');
	$coursestatistics_forums		= get_string('coursestatistics_forums', 'theme_mycampus');
	$coursestatistics_posts			= get_string('coursestatistics_posts', 'theme_mycampus');
	...
	print "<link rel=\"stylesheet\" type=\"text/css\" href=\"/theme/mycampus/style/style_table.css\" />\n";
	print "
			<BR>
	...
	for($i=0;$i<sizeof($rs_a);$i++)			{
		...
		if($专业名称!="")			{
			...
			print "<Tr class='TableData' align=center>
						...
						<td colspan=1 nowrap >".$mycampus_GetCourseTeacherNumber_TEXT."</td>
						<td colspan=1 nowrap >".$mycampus_GetCourseSectionNumber[$id]."</td>
						...
						<td colspan=1 nowrap >".$mycampus_GetCourseEnrollmentStudentNumber[$id]."</td>
						<td colspan=1 nowrap >".$mycampus_GetCourseQuizNumber[$id]."</td>
						<td colspan=1 nowrap >".mycampus_GetCourseQuestionNumber($id,$fullname)."</td>
						<td colspan=1 nowrap >".$得到课程的assign数量[$id]."</td>
						<td colspan=1 nowrap >".$mycampus_GetCourseOneMouthActivesNumber[$id]."</td>
