...
function mycampus_coursestatisticsALL($html)		{
	...
	for($i=0;$i<sizeof($rs_a);$i++)			{
		...
		if($专业名称!="")			{
			...
			print "<Tr class='TableData' align=center>
						...
						<td colspan=1 nowrap title='mycampus_GetCourseTeacherNumber_TEXT'>".$mycampus_GetCourseTeacherNumber_TEXT."</td>
						<td colspan=1 nowrap title='mycampus_GetCourseSectionNumber'>".$mycampus_GetCourseSectionNumber[$id]."</td>
						...
						<td colspan=1 nowrap title='mycampus_GetCourseEnrollmentStudentNumber'>".$mycampus_GetCourseEnrollmentStudentNumber[$id]."</td>
						<td colspan=1 nowrap title='mycampus_GetCourseQuizNumber'>".$mycampus_GetCourseQuizNumber[$id]."</td>
						<td colspan=1 nowrap title='mycampus_GetCourseQuestionNumber'>".mycampus_GetCourseQuestionNumber($id,$fullname)."</td>
						<td colspan=1 nowrap title='mycampus_GetCourseOneMouthActivesNumber'>".$mycampus_GetCourseOneMouthActivesNumber[$id]."</td>
